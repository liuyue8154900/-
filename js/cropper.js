  ...
  return {
    ...
    link: function ($scope, $el, attrs) {
      ...
      $el.on('change', function () {
        ...
        if(fileName.indexOf('JPEG',0)<0&&fileName.indexOf('JPG',0)<0&&fileName.indexOf('PNG',0)<0&&fileName.indexOf('jpeg',0)<0&&fileName.indexOf('jpg',0)<0&&fileName.indexOf('png',0)<0){
          alert("请选择jpg或者png类型的图片！");
          return;
        }
